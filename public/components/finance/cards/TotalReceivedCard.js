class TotalReceivedCard extends HTMLElement {
    constructor() {
        super();
        this.total = 0;
        this.percentage = 0;
    ...
    async loadData(startDate = null, endDate = null) {
        try {
            ...
            const response = await fetch(`/api/finance/total-received${queryParams}`);
        ...
        this.innerHTML = `
            <div class="dashboard-card p-6">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold">Total Recebido</h3>
                    <div style="background-color: var(--icon-revenue-bg); color: var(--icon-revenue-text);" class="p-2 rounded-lg">
...
customElements.define('total-received-card', TotalReceivedCard); 